...
class ExpensesList extends StatelessWidget{
  ExpensesList({super.key,required  this.expensesList,required this.onRemoveExpense});
final List<ExpensesModel> expensesList;
final void Function(ExpensesModel exp) onRemoveExpense;
final ScrollController _controller = ScrollController(initialScrollOffset: 50);
